...
const LoginPage = () => {
  ...
  return (
    <Box sx={{
      ...
      <Typography sx={{ ...centeredTextStyle, ...titleStyle, marginTop: theme => theme.spacing(8), paddingBottom: theme => theme.spacing(3) }}>
        Sign In
      </Typography>
      <Paper
        sx={{
      ...
      >
        ...
        <Button variant="contained" color="primary" fullWidth type={"submit"} onClick={() => handleClick(userName, password)}>
          Login
        </Button>
      </Paper>
    </Box>
