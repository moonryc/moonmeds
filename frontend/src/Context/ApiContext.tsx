...
export const ApiContainer = (props: any) => {
  ...
  const handleLoadingBarTurnOn = useCallback(() => {
    setNumberOfCurrentApiCalls(
      (numberOfCurrentApiCalls) => numberOfCurrentApiCalls + 1
    );
  }, []);
  ...
  const checkResponseCodes = useCallback(
    (response: any) => {
  ...
  const checkIfJWTTokenIsValid = useCallback(async () => {
    let url = `${process.env.PUBLIC_URL}/users/callback`;
  ...
  const postLogin = async (
    ...
    let url = `${process.env.PUBLIC_URL}/users/login`;
    // Default options are marked with *
    await fetch(url, {
  ...
  const postRegister = async (
    ...
    let url = `${process.env.PUBLIC_URL}/users/register`;
    // Default options are marked with *
    await fetch(url, {
  ...
  const fetchMedicationsAndDosagesAndPersons = useCallback(async () => {
    ...
    let url = `${process.env.PUBLIC_URL}/users/userData`;
    // Default options are marked with *
    await fetch(url, {
      method: "GET", // *GET, POST, PUT, DELETE, etc.
      mode: "cors", // no-cors, *cors, same-origin
  ...
  const fetchPersons = async (): Promise<void> => {
    handleLoadingBarTurnOn();
    let url = `${process.env.PUBLIC_URL}/users/usersPersons`;
    // Default options are marked with *
    await fetch(url, {
      method: "GET", // or 'PUT'
      headers: {
  ...
  const putNewMedication = async (
    ...
    handleLoadingBarTurnOn();
    let url = `${process.env.PUBLIC_URL}/medication/newMedication`;
    await fetch(url, {
  ...
  const putUpdateExistingMedication = async (
    ...
    handleLoadingBarTurnOn();
    let url = `${process.env.PUBLIC_URL}/medication/updateMedication`;
    await fetch(url, {
      method: "PUT", // *GET, POST, PUT, DELETE, etc.
      mode: "cors", // no-cors, *cors, same-origin
      cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
  ...
  const putDeleteSelectedMedications = async (
    ...
    handleLoadingBarTurnOn();
    let url = `${process.env.PUBLIC_URL}/medication/removeMedications`;
    await fetch(url, {
      method: "PUT", // *GET, POST, PUT, DELETE, etc.
      mode: "cors", // no-cors, *cors, same-origin
      cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
  ...
  const putUpdateMedicationDosage = async (
    ...
    handleLoadingBarTurnOn();
    let url = `${process.env.PUBLIC_URL}/medicationDosages/update`;
    await fetch(url, {
      method: "PUT", // *GET, POST, PUT, DELETE, etc.
      mode: "cors", // no-cors, *cors, same-origin
      cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
  ...
  const putAddPerson = async (newPerson: IPersonNameAndColor) => {
    handleLoadingBarTurnOn();
    let url = `${process.env.PUBLIC_URL}/users/addPerson`;
    await fetch(url, {
      method: "PUT", // *GET, POST, PUT, DELETE, etc.
      mode: "cors", // no-cors, *cors, same-origin
      cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
  ...
  const putRemovePerson = async (removePerson: IPersonNameAndColor) => {
    handleLoadingBarTurnOn();
    let url = `${process.env.PUBLIC_URL}/users/removePerson`;
    await fetch(url, {
      method: "PUT", // *GET, POST, PUT, DELETE, etc.
      mode: "cors", // no-cors, *cors, same-origin
      cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
