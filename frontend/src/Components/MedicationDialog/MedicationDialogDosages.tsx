...
import {Button, ButtonGroup, Collapse, DialogContentText, Divider, Paper, TextField} from "@mui/material";
...
const MedicationDialogDosages = (props: IMedicationCardAddDosagesProps) => {
    ...
    const [dosages, setDosages] = useState<IDosagesDetails[]>(props.medicationDosages);
    ...
    return (
        <>
                ...
                return <>
                    ...
                    <Collapse in={dose.isWeekly}>
                        ...
                        <ToggleButtonGroup fullWidth disabled={!dose.isWeekly}>
                            <ToggleButton value={"Sunday"} selected={dose.customWeekDays.sunday} onClick={()=>{
                                let tempArray = [...dosages]
                                tempArray[index].customWeekDays.sunday = !tempArray[index].customWeekDays.sunday
                                setDosages(tempArray)
                            }}>Sun</ToggleButton>
                            <ToggleButton value={"Monday"} selected={dose.customWeekDays.monday} onClick={()=>{
                                let tempArray = [...dosages]
                                tempArray[index].customWeekDays.monday = !tempArray[index].customWeekDays.monday
                                setDosages(tempArray)
                            }}>Mon</ToggleButton>
                            <ToggleButton value={"Tuesday"} selected={dose.customWeekDays.tuesday} onClick={()=>{
                                let tempArray = [...dosages]
                                tempArray[index].customWeekDays.tuesday = !tempArray[index].customWeekDays.tuesday
                                setDosages(tempArray)
                            }}>Tue</ToggleButton>
                            <ToggleButton value={"Wednesday"} selected={dose.customWeekDays.wednesday} onClick={()=>{
                                let tempArray = [...dosages]
                                tempArray[index].customWeekDays.wednesday = !tempArray[index].customWeekDays.wednesday
                                setDosages(tempArray)
                            }}>Wed</ToggleButton>
                        </ToggleButtonGroup>
                        <ToggleButtonGroup fullWidth disabled={!dose.isWeekly}>
                            <ToggleButton value={"Thursday"} selected={dose.customWeekDays.thursday} onClick={()=>{
                                let tempArray = [...dosages]
                                tempArray[index].customWeekDays.thursday = !tempArray[index].customWeekDays.thursday
                                setDosages(tempArray)
                            }}>Thur</ToggleButton>
                            <ToggleButton value={"Friday"} selected={dose.customWeekDays.friday} onClick={()=>{
                                let tempArray = [...dosages]
                                tempArray[index].customWeekDays.friday = !tempArray[index].customWeekDays.friday
                                setDosages(tempArray)
                            }}>Fri</ToggleButton>
                            <ToggleButton value={"Saturday"} selected={dose.customWeekDays.saturday} onClick={()=>{
                                let tempArray = [...dosages]
                                tempArray[index].customWeekDays.saturday = !tempArray[index].customWeekDays.saturday
                                setDosages(tempArray)
                            }}>Sat</ToggleButton>
                        </ToggleButtonGroup>
                        </Paper>
                    ...
                    <br/>
                    <Button fullWidth variant={"contained"} onClick={()=>deleteDosage(index)}>Delete dosage</Button>
                    <br/>
                    <br/>
                    <Divider/>
                    <br/>
            ...
            <br/>
            <Button
                onClick={() => setDosages(prevState => [...prevState,
                        {
                            amount: 0,
                            time: new Date(),
                            isDaily: false,
                ...
                size={"small"}
                fullWidth
                variant="contained">Add a Dosage</Button>
        </>
    );
};
