 ...
 * @constructor
 */
const MedicationDialogDosages: React.FC<IMedicationCardAddDosagesProps> = ({
                                                                               medicationDosages,
                                                                               updateMedicationDosages
                                                                           }) => {
    ...
    const getMonthlyDate = (monthlyDate: Date, index: number) => {
        ...
        tempMedication[index] = {...tempMedication[index], customOnceAMonthDate: monthlyDate};
        setDosages(tempMedication);
    };

    const getTime = (time: Date, index: number) => {
        let tempMedication = [...dosages];
        tempMedication[index] = {...tempMedication[index], time: time};
        setDosages(tempMedication);
    };
                    ...
                    <div key={"dosages" + index}>
                        <TextField
                            ...
                            onChange={(e) => {
                                ...
                                tempArray[index] = {...tempArray[index], amount: parseFloat(e.target.value)}
                        ...
                        <FormControl sx={{width: "35%"}}>
                            ...
                            <Select
                                ...
                                onChange={(e) => {
                                    let tempArray = [...dosages];
                                    tempArray[index] = {...tempArray[index], amountDosageType: e.target.value}
                                    setDosages(tempArray);
                                }}
                            >
                        ...
                        <Paper>
                            <ToggleButtonGroup fullWidth exclusive>
                                <ToggleButton
                                    ...
                                    onClick={() => {
                                        let tempArray = [...dosages];
                                        tempArray[index] = {...tempArray[index], isDaily: true}
                                        tempArray[index] = {...tempArray[index], isWeekly: false}
                                        tempArray[index] = {...tempArray[index], isOnceAMonth: false}
                                        setDosages(tempArray);
                                    }}
                                >
                                    Daily
                                ...
                                <ToggleButton
                                    ...
                                    onClick={() => {
                                        let tempArray = [...dosages];
                                        tempArray[index] = {...tempArray[index], isDaily: false}
                                        tempArray[index] = {...tempArray[index], isWeekly: true}
                                        tempArray[index] = {...tempArray[index], isOnceAMonth: false}
                                        setDosages(tempArray);
                                    }}
                                >
                                ...
                                <ToggleButton
                                    ...
                                    onClick={() => {
                                        ...
                                        tempArray[index] = {...tempArray[index], isDaily: false}
                                        tempArray[index] = {...tempArray[index], isWeekly: false}
                                        tempArray[index] = {...tempArray[index], isOnceAMonth: true}
                                        setDosages(tempArray);
                                    }}
                                >
                                    Monthly
                                    ...
                                    <ToggleButton
                                        ...
                                        onClick={() => {
                                            ...
                                            tempArray[index] = {
                                                ...tempArray[index],
                                                customWeekDays: {
                                                    ...tempArray[index].customWeekDays,
                                                    sunday: !tempArray[index].customWeekDays.sunday
                                                }
                                            }
                                            setDosages(tempArray);
                                        }}
                                    ...
                                    <ToggleButton
                                        ...
                                        onClick={() => {
                                            ...
                                            tempArray[index] = {
                                                ...
                                                customWeekDays: {
                                                    ...tempArray[index].customWeekDays,
                                                    monday: !tempArray[index].customWeekDays.monday
                                                }
                                            }
                                            setDosages(tempArray);
                                        }}
                                    ...
                                    <ToggleButton
                                        ...
                                        onClick={() => {
                                            ...
                                            tempArray[index] = {
                                                ...
                                                customWeekDays: {
                                                    ...tempArray[index].customWeekDays,
                                                    tuesday: !tempArray[index].customWeekDays.tuesday
                                                }
                                            }
                                            setDosages(tempArray);
                                        }}
                                    ...
                                    <ToggleButton
                                        ...
                                        onClick={() => {
                                            ...
                                            tempArray[index] = {
                                                ...
                                                customWeekDays: {
                                                    ...tempArray[index].customWeekDays,
                                                    wednesday: !tempArray[index].customWeekDays.wednesday
                                                }
                                            }
                                            setDosages(tempArray);
                                        }}
                                    ...
                                    <ToggleButton
                                        ...
                                        onClick={() => {
                                            ...
                                            tempArray[index] = {
                                                ...
                                                customWeekDays: {
                                                    ...tempArray[index].customWeekDays,
                                                    thursday: !tempArray[index].customWeekDays.thursday
                                                }
                                            }
                                            setDosages(tempArray);
                                        }}
                                    ...
                                    <ToggleButton
                                        ...
                                        onClick={() => {
                                            ...
                                            tempArray[index] = {
                                                ...
                                                customWeekDays: {
                                                    ...tempArray[index].customWeekDays,
                                                    friday: !tempArray[index].customWeekDays.friday
                                                }
                                            }
                                            setDosages(tempArray);
                                        }}
                                    ...
                                    <ToggleButton
                                        ...
                                        onClick={() => {
                                            ...
                                            tempArray[index] = {
                                                ...
                                                customWeekDays: {
                                                    ...tempArray[index].customWeekDays,
                                                    saturday: !tempArray[index].customWeekDays.saturday
                                                }
                                            }
                                            setDosages(tempArray);
                                        }}
