...
const MedicationDosageDetails = (props: IMedicationDosageDetails) => {
    ...
    const getPersonColor = () => {
     ...
     const owner = <Chip sx={{bgcolor:props.medication.medicationOwner.color}} icon={<Face/>} label={props.medication.medicationOwner.name} />
     const medication = <Chip sx={{bgcolor:props.medication.medicationOwner.color}} icon={<MedicationIcon/>} label={props.medication.prescriptionName}/>
